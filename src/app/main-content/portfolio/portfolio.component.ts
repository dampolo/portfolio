...
export class PortfolioComponent {
  ...
  portfolio = [
    ...
    {
      id: 5,
      image: "assets/img/startinkrypto.png",
      project_name: 'Start in Krypto',
      language: 'JavaScript | HTML | CSS',
      description: 'MY_PROJECTS.PROJECT_6',
      test: 'Live test',
      test_link: 'https://www.startinkrypto.de/',
      git_hub: 'GitHub',
      link_git_hub: 'https://github.com/dampolo/startinkrypto'
    },
  ]
}
